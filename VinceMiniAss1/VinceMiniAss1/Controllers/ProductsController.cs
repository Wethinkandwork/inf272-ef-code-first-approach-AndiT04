...
namespace VinceMiniAss1.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProductID,ProductName,ProductModelYear,ProductListPrice,BrandID,CategoryID")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProductID,ProductName,ProductModelYear,ProductListPrice,BrandID,CategoryID")] Product product)
        {
            if (ModelState.IsValid)
            {
